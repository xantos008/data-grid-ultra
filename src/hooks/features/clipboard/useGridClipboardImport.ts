...
import { GRID_DETAIL_PANEL_TOGGLE_FIELD, GRID_REORDER_COL_DEF } from 'data-grid-extra';
import { unstable_debounce as debounce } from '@mui/utils';
import { GridApiUltra, GridPrivateApiUltra } from '../../../models/gridApiUltra';
import type { DataGridUltraProcessedProps } from '../../../models/dataGridUltraProps';
...
class CellValueUpdater {
  ...
  options: {
    ...
    processRowUpdate: DataGridUltraProcessedProps['processRowUpdate'];
    onProcessRowUpdateError: DataGridUltraProcessedProps['onProcessRowUpdateError'];
    getRowId: DataGridUltraProcessedProps['getRowId'];
  };
...
function defaultPasteResolver({
  ...
  pagination: DataGridUltraProcessedProps['pagination'];
}) {
