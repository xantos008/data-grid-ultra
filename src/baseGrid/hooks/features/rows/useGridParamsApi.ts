...
function warnMissingColumn(field: string) {
  console.warn(
    [
      `You are calling getValue('${field}') but the column \`${field}\` is not defined.`,
...
const getCellValueWarning = buildWarning([
  `You are calling getValue. This method is deprecated and will be removed in the next major version.`,
